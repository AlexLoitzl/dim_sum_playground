...
Section echo_getc.
  ...
  Lemma echo_getc_sim :
    ...
    (MLFRun None, [], rec_init echo_prog, (getc_spec_priv, 0)) ⪯{m_t,
  ...
  Proof.
    ...
    iMod (mstate_var_split γs_t 0 with "[$]") as "[Hγs_t Hγs_t']".
    ...
    (* TODO: This looks a little bit sus with the 0 *)
